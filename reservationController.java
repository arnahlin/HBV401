...
public class ReservationController
{
	public static void main( String[] args ) throws Exception {
		...
		/* Ath, ég commentaði út þessar 3 línur því ég er búin að setja þær inn í gagnagrunnana til að sjá hvort að tengingin virki.
		 Ef maðu keyrir skjalið aftur með þessum gildum þá þá kemur villa út af primary key. Þ.e maður þarf að setja inn ný gildi. */
